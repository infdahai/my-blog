---
citekey: "kimAreVisualPlaceRecognitionModelsRecognizingPlacesConditions2026"
...
> Beomsu Kim, Minwoo Jung, Giseop Kim · 2026
> [arXiv](https://arxiv.org/abs/2608.06847) · [PDF](https://arxiv.org/pdf/2608.06847)
...
Long-term Visual Place Recognition (VPR) is typically evaluated by matching queries from one condition against a database from another. Crowdsourced map databases, however, may mix conditions and include images that resemble the query in condition but depict different places.
